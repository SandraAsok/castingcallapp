...
class SideKickScreen extends StatelessWidget {
  SideKickScreen({super.key});

  final Stream<QuerySnapshot> _sidekickstream = FirebaseFirestore.instance
      .collection("posts")
      .where("role", isEqualTo: 'Side Kick')
      .snapshots();
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: const PreferredSize(
            ...
            child: RolesAppBar(title: "SideKick")),
        body: SingleChildScrollView(
          child: Column(
            children: [
              kheight25,
              StreamBuilder<QuerySnapshot>(
                  stream: _sidekickstream,
