...
class CameoScreen extends StatelessWidget {
  CameoScreen({super.key});

  final Stream<QuerySnapshot> _cameostream = FirebaseFirestore.instance
      .collection("posts")
      .where("role", isEqualTo: 'Cameo')
      .snapshots();
