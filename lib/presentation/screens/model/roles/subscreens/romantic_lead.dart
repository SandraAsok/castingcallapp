...
class RomeoScreen extends StatelessWidget {
  RomeoScreen({super.key});

  final Stream<QuerySnapshot> _romeostream = FirebaseFirestore.instance
      .collection("posts")
      .where("role", isEqualTo: 'Romeo')
      .snapshots();
