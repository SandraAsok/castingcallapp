...
class VillainScreen extends StatelessWidget {
  VillainScreen({super.key});

  final Stream<QuerySnapshot> _villainstream = FirebaseFirestore.instance
      .collection("posts")
      .where("role", isEqualTo: 'Villain')
      .snapshots();
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: const PreferredSize(
            ...
            child: RolesAppBar(title: "Villain")),
        body: SingleChildScrollView(
          child: Column(
            children: [
              kheight25,
              StreamBuilder<QuerySnapshot>(
                  stream: _villainstream,
