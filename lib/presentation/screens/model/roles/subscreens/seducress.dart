...
class SeductressScreen extends StatelessWidget {
  SeductressScreen({super.key});

  final Stream<QuerySnapshot> _seductressstream = FirebaseFirestore.instance
      .collection("posts")
      .where("role", isEqualTo: 'Seductress')
      .snapshots();
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: const PreferredSize(
            ...
            child: RolesAppBar(title: "Seductress")),
        body: SingleChildScrollView(
          child: Column(
            children: [
              kheight25,
              StreamBuilder<QuerySnapshot>(
                  stream: _seductressstream,
